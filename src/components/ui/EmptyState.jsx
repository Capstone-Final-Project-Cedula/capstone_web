...
const EmptyState = ({
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center py-14 px-6 ${className}`}>
      {Icon && (
        <div className="w-14 h-14 rounded-[var(--radius-lg)] bg-[var(--color-primary-light)] flex items-center justify-center mb-4">
      ...
      {description && (
        <p className="text-sm text-[var(--color-neutral-500)] max-w-sm mb-5">{description}</p>
      )}
